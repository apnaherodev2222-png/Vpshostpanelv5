        ...
        if lang == 'py':
            cmd = [
                ...
                (
                    ...
                    '  pip install -r /workspace/requirements.txt -q --no-cache-dir; '
                    '  echo "✅ Requirements installed"; '
                    'fi; '
                    f'python /workspace/{file_path.name}'
                )
            ]
        else:  # js
            cmd = [
                ...
                (
                    ...
                    '  npm install --prefix /workspace --quiet; '
                    '  echo "✅ Packages installed"; '
                    'fi; '
                    f'node /workspace/{file_path.name}'
                )
            ]
